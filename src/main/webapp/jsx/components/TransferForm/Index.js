...
const Tracking = (props) => {
  ...
  const validate = async () => {
    temp.reasonForTransfer =
      payload.reasonForTransfer !== "" ? "" : "This field is required";
    temp.modeOfHIVTest =
      payload.modeOfHIVTest !== "" ? "" : "This field is required";
    temp.encounterDate =
      payload.encounterDate !== "" ? "" : "This field is required";
    ...
    if (payload.encounterDate !== "") {
      try {
        ...
        if (response.data === "Date is valid.") {
          ...
          response.data ===
          "The selected date is already used for transfer in or out."
        ) {
          temp.encounterDate =
            "The selected date is already used for transfer in or out";
        } else {
        ...
        <CardBody>
          <form>
            <div className="row">
              <h2>
                Transfer{" "}
                {patientCurrentStatus === "ART TRANSFER OUT" ? "In " : "Out "}{" "}
                Form
              </h2>
              <br />
              <div class="row">
