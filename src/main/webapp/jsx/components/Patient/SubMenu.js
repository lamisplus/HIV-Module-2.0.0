                  ...
                  <Menu size="tiny" color={"black"} inverted>
                    ...
                    {isPatientActive && (
                      <>
                        ...
                        {permissions?.includes("Care Card") && (
                          <Menu.Item
                        ...
                        {permissions?.includes("EAC Monitoring Register") && (
                          <Menu.Item
                            ...
                            <Dropdown item text="Other Forms">
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Item
                                  ...
                                  active={
                                    activeItem === "clientVerificationForm"
                                  }
                        ...
                        {permissions?.includes(
                          "HIV Care and Treatment Transfer Form"
                        ) && (
                          <Menu.Item
                            onClick={() => loadTransferForm(patientObj)}
                            name="transfer"
